    ...
    <div className="mx-auto max-w-5xl p-6">
      ...
      {activeTab === "gemini" && (
        <div className="space-y-4">
          ...
          {/* From Scratch Prompt */}
          <Card className="border-zinc-800 bg-zinc-900/50 overflow-hidden">
            <SectionHeader section="from-scratch" title="From Scratch Prompt" />
            {expandedSections["from-scratch"] && (
              <div className="border-t border-zinc-800 p-4 space-y-3">
                <p className="text-xs text-zinc-400">
                  Used when creating a post from a text idea or inspiration images (not recreating an existing post).
                </p>
                {isEditMode ? (
                  <Textarea
          ...
          {/* Copy Post Prompt */}
          <Card className="border-zinc-800 bg-zinc-900/50 overflow-hidden">
            <SectionHeader section="copy-post" title="Copy Post Prompt" />
            {expandedSections["copy-post"] && (
              <div className="border-t border-zinc-800 p-4 space-y-3">
                <p className="text-xs text-zinc-400">
                  Used when recreating an existing post from reference images. Includes analysis logic to extract pose,
                  composition, and style while excluding identity features.
                </p>
                {isEditMode ? (
                  <Textarea
